...
def solution_record(row):
    if yes(row.get("checker_verified_solution")): return "Verified; file not published", "feasible"
    if yes(row.get("complete_solution_available")): return "Recorded; file not published", "open"
